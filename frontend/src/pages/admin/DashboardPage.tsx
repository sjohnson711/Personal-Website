...
export default function DashboardPage() {
  ...
  return (
    <div className="fade-up" style={{ maxWidth: "980px", margin: "0 auto", padding: "4.5rem 1.5rem 7rem" }}>

      {/* Top bar */}
      <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", flexWrap: "wrap", gap: "1.25rem", marginBottom: "3rem" }}>
        <div>
          ...
          <h1 style={{ fontFamily: '"Playfair Display", Georgia, serif', fontSize: "2.2rem", fontWeight: 900, color: "#0F1B35", margin: 0, letterSpacing: "-0.02em" }}>Dashboard</h1>
      ...
      <div style={{ background: "#FFFFFF", border: "1px solid #EAE4D8", borderRadius: "0.875rem", overflow: "hidden", boxShadow: "0 1px 8px rgba(28,25,23,0.06)" }}>
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "1.1rem 1.75rem", borderBottom: "1px solid #F0EBE2", background: "#FAFAF9" }}>
        ...
        {loading ? (
          <div style={{ padding: "3.5rem", textAlign: "center", color: "#C4BAB0", fontFamily: '"DM Sans", sans-serif' }}>Loading…</div>
        ) : articles.length === 0 ? (
