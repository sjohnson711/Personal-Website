...
export default function EditArticlePage() {
  ...
  if (notFound || !article) return (
    <div style={{ maxWidth: "860px", margin: "0 auto", padding: "4.5rem 1.5rem" }}>
      ...
      <div style={{ background: "#FFFFFF", border: "1px solid #EAE4D8", borderRadius: "0.875rem", padding: "4rem", textAlign: "center", marginTop: "2rem" }}>
  ...
  return (
    <div className="fade-up" style={{ maxWidth: "860px", margin: "0 auto", padding: "4.5rem 1.5rem 7rem" }}>
      <div style={{ marginBottom: "2.5rem" }}>
        ...
        <h1 style={{ fontFamily: '"Playfair Display", Georgia, serif', fontSize: "2.2rem", fontWeight: 900, color: "#0F1B35", margin: 0, letterSpacing: "-0.02em" }}>Edit Article</h1>
